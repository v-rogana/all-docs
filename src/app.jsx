...
import {
  C, ALLOS_INST,
  valorPorExtenso, mesesPorExtenso,
  sec, p, center, paras, sigBlock, docHeader, LOGO_LIGHT_URL,
  exportPDF, exportDOCX,
} from "./core.js";
import { ActionBtn, DocPaper } from "./ui.jsx";
import EstagiosArea, { ESTAGIOS_CSS } from "./estagios/ui.jsx";
...
/* ════════════════════════════════════════════
   ...
   Paleta, dados institucionais, helpers de HTML e exportadores
   vivem em core.js; primitivas de UI em ui.jsx — ambos também
   usados pela área de estágios (estagios/).
   ════════════════════════════════════════════ */
  ...
  return (
    <div style={{position:"fixed",inset:0,zIndex:1000,display:"flex"}}>
      ...
      <div style={{position:"relative",width:280,maxWidth:"80vw",background:C.sidebar,overflowY:"auto",zIndex:1}}>
        ...
        <SidebarSectionLabel>Outra área</SidebarSectionLabel>
        <SidebarItem icon="🎓" label="Estágios e contratos" active={view === "estagios"} open
          onClick={() => { setView("estagios"); onClose(); }} />
      </div>
    </div>
  );
}
      ...
      <div style={{display:"flex",flex:1,overflow:"hidden",position:"relative",zIndex:1}}>
        ...
        <div className="app-sidebar" style={{
          ...
          <div style={{padding:"8px 0 16px",flex:1,overflowY:"auto"}}>
            ...
            <SidebarItem icon="🎓" label="Estágios e contratos"
              active={view === "estagios"} open={sidebarOpen}
              onClick={() => setView("estagios")} />
          </div>
